      ...
      >
        <div className="glass-card p-8">
          <div className="text-center mb-8">
            ...
            <p className="text-neutral-text-secondary">Sign in to manage your expenses</p>
          </div>
          ...
          {error && (
            <motion.div
              ...
              className="bg-red-50 text-red-500 p-3 rounded-lg mb-6 flex items-center gap-2 text-sm"
            >
              <AlertCircle size={16} />
              {error}
            </motion.div>
